...
readonly OS_GO_PACKAGE=github.com/openshift/cluster-kube-scheduler-operator
...
readonly OS_CROSS_COMPILE_TARGETS=(
  cmd/cluster-kube-scheduler-operator
)
...
function os::build::images() {
  ...
  os::build::image "${tag_prefix}-cluster-kube-scheduler-operator" .
}
