...
// tchap:correct-certrotation-annotation-update-logging
replace github.com/openshift/library-go => github.com/tchap/library-go v0.0.0-20260113154628-16bafb54c851
