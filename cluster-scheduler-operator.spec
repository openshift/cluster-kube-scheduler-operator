...
%global package_name origin-cluster-kube-scheduler-operator
%global product_name OpenShift Cluster kube-scheduler Operator
%global import_path github.com/openshift/cluster-kube-scheduler-operator
...
for bin in cluster-kube-scheduler-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-kube-scheduler-operator
