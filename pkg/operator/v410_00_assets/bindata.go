...
// bindata/v4.1.0/kube-scheduler/defaultconfig-postbootstrap-with-policy.yaml
// bindata/v4.1.0/kube-scheduler/defaultconfig-postbootstrap.yaml
// bindata/v4.1.0/kube-scheduler/defaultconfig.yaml
...
var _v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYaml = []byte(`apiVersion: kubescheduler.config.k8s.io/v1alpha1
...
func v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYamlBytes() ([]byte, error) {
	return _v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYaml, nil
}

func v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYaml() (*asset, error) {
	bytes, err := v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v4.1.0/kube-scheduler/defaultconfig-postbootstrap-with-policy.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _v410KubeSchedulerDefaultconfigPostbootstrapYaml = []byte(`apiVersion: kubescheduler.config.k8s.io/v1alpha1
kind: KubeSchedulerConfiguration
clientConnection:
  kubeconfig: /etc/kubernetes/static-pod-resources/configmaps/scheduler-kubeconfig/kubeconfig
`)

func v410KubeSchedulerDefaultconfigPostbootstrapYamlBytes() ([]byte, error) {
	return _v410KubeSchedulerDefaultconfigPostbootstrapYaml, nil
}

func v410KubeSchedulerDefaultconfigPostbootstrapYaml() (*asset, error) {
	bytes, err := v410KubeSchedulerDefaultconfigPostbootstrapYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v4.1.0/kube-scheduler/defaultconfig-postbootstrap.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _v410KubeSchedulerDefaultconfigYaml = []byte(`apiVersion: kubescheduler.config.k8s.io/v1alpha1
kind: KubeSchedulerConfiguration
`)

func v410KubeSchedulerDefaultconfigYamlBytes() ([]byte, error) {
	return _v410KubeSchedulerDefaultconfigYaml, nil
}

func v410KubeSchedulerDefaultconfigYaml() (*asset, error) {
	bytes, err := v410KubeSchedulerDefaultconfigYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v4.1.0/kube-scheduler/defaultconfig.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _v410KubeSchedulerPolicyconfigmapRoleYaml = []byte(`#As of now, system:kube-scheduler role cannot list configmaps from openshift-kube-scheduler namespace. So, creating a role.
...
var _bindata = map[string]func() (*asset, error){
	...
	"v4.1.0/kube-scheduler/defaultconfig-postbootstrap-with-policy.yaml": v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYaml,
	"v4.1.0/kube-scheduler/defaultconfig-postbootstrap.yaml":             v410KubeSchedulerDefaultconfigPostbootstrapYaml,
	"v4.1.0/kube-scheduler/defaultconfig.yaml":                           v410KubeSchedulerDefaultconfigYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v4.1.0": {nil, map[string]*bintree{
		"kube-scheduler": {nil, map[string]*bintree{
			...
			"defaultconfig-postbootstrap-with-policy.yaml": {v410KubeSchedulerDefaultconfigPostbootstrapWithPolicyYaml, map[string]*bintree{}},
			"defaultconfig-postbootstrap.yaml":             {v410KubeSchedulerDefaultconfigPostbootstrapYaml, map[string]*bintree{}},
			"defaultconfig.yaml":                           {v410KubeSchedulerDefaultconfigYaml, map[string]*bintree{}},
