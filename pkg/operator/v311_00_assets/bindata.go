...
// sources:
// bindata/v3.11.0/kube-scheduler/auth-delegator-rolebinding.yaml
...
var _v3110KubeSchedulerAuthDelegatorRolebindingYaml = []byte(`apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
  namespace: kube-system
  name: system:openshift:auth-delegator-kube-scheduler
roleRef:
...
func v3110KubeSchedulerAuthDelegatorRolebindingYamlBytes() ([]byte, error) {
	return _v3110KubeSchedulerAuthDelegatorRolebindingYaml, nil
}

func v3110KubeSchedulerAuthDelegatorRolebindingYaml() (*asset, error) {
	bytes, err := v3110KubeSchedulerAuthDelegatorRolebindingYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/kube-scheduler/auth-delegator-rolebinding.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"v3.11.0/kube-scheduler/auth-delegator-rolebinding.yaml":              v3110KubeSchedulerAuthDelegatorRolebindingYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v3.11.0": {nil, map[string]*bintree{
		"kube-scheduler": {nil, map[string]*bintree{
			"auth-delegator-rolebinding.yaml": {v3110KubeSchedulerAuthDelegatorRolebindingYaml, map[string]*bintree{}},
