...
import (
	...
	kubescheduler "github.com/openshift/cluster-kube-scheduler-operator/pkg/generated/informers/externalversions/kubescheduler"
...
func (f *sharedInformerFactory) Kubescheduler() kubescheduler.Interface {
	return kubescheduler.New(f, f.namespace, f.tweakListOptions)
}
